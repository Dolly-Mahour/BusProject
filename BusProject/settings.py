...
SECRET_KEY = 'django-insecure-)h^s^0(a9-hhs*jf8kyehnqyvqnaak$=)a#$5i(&y665q&^%yg'
...
ALLOWED_HOSTS = ['192.168.1.8','192.168.5.3', 'localhost', '127.0.0.1','192.168.1.13',' 192.168.5.6','DollyMahour.pythonanywhere.com']
# ALLOWED_HOSTS = []
